...
| **ERP Data**        | "ERP", "sync", "parity", "valor", "ctEmpresa", "quebra", "batendo", "controladoria", "R$" | `erp-data-analyst`               | ✅ YES       |
...
| **ERP/Data**    | ERP, sync, parity, valor, ctEmpresa, quebra, controladoria, R$, faturamento, perda | `erp-data-analyst` |
